...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210826_wedoweb_e4ab9b26f53ce3c72939_20210826204359_archive.zip';
	const ARCHIVE_SIZE		 = '24493671';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'e4ab9b2-26204359';
    const SECONDARY_PACKAGE_HASH = 'f093779-26204359';
	const VERSION			 = '1.4.2';
